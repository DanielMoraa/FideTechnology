<?php
    ...
    // Ahora aseguramos que $categoria_id se define correctamente
    ...
    {
        // Añadimos el acceso a $categoria_id como variable global
        global $categoria_id;

        // Verificamos el perfil de usuario desde la sesión
        $usuario = VerificarSesion();
        $nombrePerfil = $_SESSION["NombrePerfil"] ?? ""; // Aseguramos que esté disponible
        ...
        // Mostramos botones solo para "Vendedor" o "Administrador"
        if ($nombrePerfil === "Vendedor" || $nombrePerfil === "Administrador") {
            echo '<li><a href="../Productos/formularioAgregarProducto.php">Agregar Producto</a></li>
                  <li><a href="../Productos/actualizarProducto.php">Actualizar Producto</a></li>';
        }
        ...
        ($categoria_id > 0 ? '<input type="hidden" name="categoria" value="' . $categoria_id . '">' : '') . '
        </form>
        </div>
        </li>
